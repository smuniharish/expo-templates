# expo template (t1) - Starter Template

expo template - starter template t1
...
3. Run the command "npm install -g sharp-cli@^2.1.0"
4. npx expo start (By defualt, It will run in development mode)
```
## Installed packages
...
| :-------- | :------- | :-------| :------- |
| `expo` | https://docs.expo.dev/ | https://github.com/expo/expo | 49.0.6 |
| `expo-asset` | https://docs.expo.dev/versions/latest/sdk/asset/ | https://github.com/expo/expo | 8.10.1 |
| `expo-auth-session` | https://docs.expo.dev/versions/latest/sdk/auth-session/ | https://github.com/expo/expo | 5.0.2 |
| `expo-background-fetch` | https://docs.expo.dev/versions/latest/sdk/auth-session/ | https://github.com/expo/expo | 11.3.0 |
| `expo-blur` | https://docs.expo.dev/versions/latest/sdk/blur-view/ | https://github.com/expo/expo | 12.4.1 |
| `expo-build-properties` | https://docs.expo.dev/versions/latest/sdk/build-properties/ | https://github.com/expo/expo | 0.8.3 |
| `expo-camera` | https://docs.expo.dev/versions/latest/sdk/camera/ | https://github.com/expo/expo | 13.4.2 |
| `expo-checkbox` | https://docs.expo.dev/versions/latest/sdk/checkbox/ | https://github.com/expo/expo | 2.4.0 |
| `expo-constants` | https://docs.expo.dev/versions/latest/sdk/constants/ | https://github.com/expo/expo | 14.4.2 |
| `expo-crypto` | https://docs.expo.dev/versions/latest/sdk/crypto/ | https://github.com/expo/expo | 12.4.1 |
| `expo-dev-client` | https://docs.expo.dev/eas-update/expo-dev-client/ | https://github.com/expo/expo | 2.4.6 |
| `expo-device` | https://docs.expo.dev/versions/latest/sdk/device/ | https://github.com/expo/expo | 5.4.0 |
| `expo-file-system` | https://docs.expo.dev/versions/latest/sdk/filesystem/ | https://github.com/expo/expo | 15.4.2 |
| `expo-font` | https://docs.expo.dev/versions/latest/sdk/font/ | https://github.com/expo/expo | 11.4.0 |
| `expo-image` | https://docs.expo.dev/versions/latest/sdk/image/ | https://github.com/expo/expo | 1.3.2 |
| `expo-image-picker` | https://docs.expo.dev/versions/latest/sdk/imagepicker/ | https://github.com/expo/expo | 14.3.2 |
| `expo-intent-launcher` | https://docs.expo.dev/versions/latest/sdk/intent-launcher/ | https://github.com/expo/expo | 10.7.0 |
| `expo-linear-gradient` | https://docs.expo.dev/versions/latest/sdk/linear-gradient/ | https://github.com/expo/expo | 12.3.0 |
| `expo-linking` | https://docs.expo.dev/versions/latest/sdk/linking/ | https://github.com/expo/expo | 5.0.2 |
| `expo-local-authentication` | https://docs.expo.dev/versions/latest/sdk/local-authentication/ | https://github.com/expo/expo | 13.4.1 |
| `expo-localization` | https://docs.expo.dev/versions/latest/sdk/localization/ | https://github.com/expo/expo | 14.3.0 |
| `expo-navigation-bar` | https://docs.expo.dev/versions/latest/sdk/navigation-bar/ | https://github.com/expo/expo | 2.3.0 |
| `expo-notifications` | https://docs.expo.dev/versions/latest/sdk/notifications/ | https://github.com/expo/expo | 0.20.1 |
| `expo-print` | https://docs.expo.dev/versions/latest/sdk/print/ | https://github.com/expo/expo | 12.4.0 |
| `expo-router` | https://docs.expo.dev/routing/introduction/ | https://github.com/expo/expo | 2.0.0 |
...
| `expo-updates` | https://docs.expo.dev/versions/latest/sdk/updates/ | https://github.com/expo/expo | 0.18.11 |
...
| `react-native` | https://github.com/facebook/react-native#readme | https://github.com/facebook/react-native | 0.72.3 |
...
| `react-native-modal-datetime-picker` | https://github.com/mmazzarolo/react-native-modal-datetime-picker#readme | https://github.com/mmazzarolo/react-native-modal-datetime-picker | 17.0.0 |
...
| Package Name | Home page link | Repository link | installed Version |
| :-------- | :------- | :-------| :------- |
| `@babel/core` | https://babel.dev/docs/babel-core | https://github.com/babel/babel | 7.22.9 |
...
| `@types/react` | https://github.com/DefinitelyTyped/DefinitelyTyped#readme | https://github.com/DefinitelyTyped/DefinitelyTyped | 18.2.18 |
| `cross-env` | https://github.com/kentcdodds/cross-env#readme | https://github.com/kentcdodds/cross-env | 7.0.3 |
| `jest` | https://docs.expo.dev/ | https://github.com/expo/expo | 29.6.2 |
...
| `config` | generic | index.tsx | this file is the registry for the config files. Please register config within this folder and export it |
...
| `package` | - | index.tsx | this file is the registry for the package files ( Some times we need to create own package for making the development easier !!! ). Please register packages within folder and export it. ( Note: All the packages are in folder form.Every package has its own registry ) |
